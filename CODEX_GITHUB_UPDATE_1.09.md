...
源码根目录包含 DEVELOPMENT_HISTORY.md。任何 AI 或开发者继续本项目时，都必须先阅读该文件，并在每次修改代码后追加本次开发经过，包括用户目标、问题原因、设计决定、修改文件、构建/测试结果和仍需人工验证的内容。

不得删除或覆盖旧记录。若更新版本、元数据或用户可见功能，还必须同步更新 CMake、Projucer、README、Help/版本显示及对应的 GitHub 更新说明。
